...
jailbreaking by analyzing multiple discriminative metrics across all model layers.

The approach uses the SGXSTest dataset (100 pairs of similar prompts, one benign and one malicious)
to evaluate layer-wise discriminative power through:
...
providing a principled foundation for layer selection in jailbreak detection systems.
"""
